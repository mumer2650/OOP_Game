...
{
    public partial class newLevel4 : Form
    {
        Player player;
        Traffic traffic;
        TrafficCar1 Car1;
        ...
        // 
        private void newLevel4_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void newLevel4_KeyUp(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Left)
            {
